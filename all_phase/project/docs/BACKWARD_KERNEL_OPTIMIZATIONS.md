...
| Optimization | Component | Speedup |
|--------------|-----------|---------|
| Two-pass ReLU backward | Backward Input | 1.5× |
| Warp shuffle reduction | Backward Weight/Bias | 10× |
| Tiled computation | Backward Weight | 3× |
| Size-specific kernels | All | 2× |
| FP32 accumulation | Backward Weight | Precision |
| Fused SGD update | Weight Update | 1.5× |
| **Combined** | **Total** | **~30×** |
